...
class TestMethods(unittest.TestCase):
    ...
    def test_get(self, boto3):
        ...
        boto3.resource.return_value.Table.return_value.get_item.return_value = {'Item': {'id': '2cc2b7e6-3953-11e9-abe6-2816ad91e759'}}
    ...
    def test_update(self, boto3):
        ...
        boto3.resource.return_value.Table.return_value.update_item.return_value = {'Attributes': {'id':'2cc2b7e6-3953-11e9-abe6-2816ad91e759'}}
        event = {'pathParameters': {'id': '2cc2b7e6-3953-11e9-abe6-2816ad91e759'}, "body": "{ \"text\": \"hola\", \"checked\": \"True\" }"}
